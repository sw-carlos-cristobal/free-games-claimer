...
try {
  ...
  for (const { title, url } of external_info) {
    ...
    if (cfg.dryrun) continue;
    if (cfg.interactive && !await confirm()) continue;
    await Promise.any([page.click('button:has-text("Get game")'), page.click('p:has-text("Claim")'), page.click('button:has-text("Complete Claim")'), page.waitForSelector('div:has-text("Link game account")'), page.waitForSelector('.thank-you-title:has-text("Success")')]); // waits for navigation
  ...
  if (cfg.pg_claimdlc) {
    ...
    for (const dlc of dlcs) {
      ...
      try {
        ...
        await Promise.any([page.click('button:has-text("Get in-game content")'), page.click('button:has-text("Claim your gift")'), page.click('p:has-text("Claim")').then(() => page.click('button:has-text("Continue")'))]);
